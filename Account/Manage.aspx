        ...
        <div class="col-md-12">
            <section id="passwordForm">
                <asp:PlaceHolder runat="server" ID="setPassword" Visible="false">
                    <p>
                        Vous n'avez pas de mot de passe pour ce site local. Ajoutez un mot de passe local
                        afin que vous puissiez vous connecter sans ID de connexion externe.
                    </p>
                    <div class="form-horizontal">
                        <h4>Définir le format du mot de passe</h4>
                        <hr />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                ...
                                <asp:RequiredFieldValidator runat="server" ControlToValidate="CurrentPassword"
                                    CssClass="text-danger" ErrorMessage="Le champ du mot de passe actuel est obligatoire."
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                ...
                                <asp:RequiredFieldValidator runat="server" ControlToValidate="ConfirmNewPassword"
                                    CssClass="text-danger" Display="Dynamic" ErrorMessage="Confirmer le nouveau mot de passe est obligatoire."
                                    ValidationGroup="ChangePassword" />
